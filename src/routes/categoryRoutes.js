...
router.post("/createCategory", authMiddleware(["user", "admin", "seller"]), upload.single('image'), category.createCategory);
router.get("/getCategory", category.getCategory);
router.get("/getPopularCategory", category.getPopularCategory);
router.post("/updateCategory", authMiddleware(["user", "admin", "seller"]), upload.single('image'), category.updateCategory);
